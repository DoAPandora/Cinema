...
{
private:
    inline static std::vector<void (*)(Logger_T& logger)> installFuncs;

public:
    static void AddInstallFunc(void (*installFunc)(Logger_T& logger))
    {
        installFuncs.push_back(installFunc);
    }

    static inline void InstallHooks(Logger_T& logger)
    {
